...
_lr_productions = [
  ...
  ('descricao_individuals -> INDIVIDUALS COLON ID COMMA ID descricao_individuals','descricao_individuals',6,'p_descricao_individuals','app.py',199),
  ('descricao_individuals -> INDIVIDUALS COLON ID','descricao_individuals',3,'p_descricao_individuals','app.py',200),
  ('descricao_individuals -> empty','descricao_individuals',1,'p_descricao_individuals','app.py',201),
  ('expressao_classes -> ID','expressao_classes',1,'p_expressao_classes','app.py',207),
  ('expressao_classes -> ID AND LPAREN expressao_classes COMMA expressao_classes RPAREN','expressao_classes',7,'p_expressao_classes','app.py',208),
  ('expressao_classes -> ID AND LPAREN expressao_classes COMMA ID SOME ID RPAREN','expressao_classes',9,'p_expressao_classes','app.py',209),
  ('expressao_classes -> ID AND LPAREN ID SOME ID RPAREN','expressao_classes',7,'p_expressao_classes','app.py',210),
  ('expressao_classes -> ID AND LPAREN ID COMMA ID SOME ID RPAREN','expressao_classes',9,'p_expressao_classes','app.py',211),
  ('empty -> <empty>','empty',0,'p_empty','app.py',228),
]
