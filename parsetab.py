...
_lr_productions = [
  ...
  ('descricao_classes -> CLASS COLON ID subclasso_classes descricao_classes','descricao_classes',5,'p_descricao_classes','app.py',180),
  ('descricao_classes -> CLASS COLON ID','descricao_classes',3,'p_descricao_classes','app.py',181),
  ('subclasso_classes -> SUBCLASSOF COLON expressao_classes propriedades descricao_classes','subclasso_classes',5,'p_subclasso_classes','app.py',191),
  ('subclasso_classes -> SUBCLASSOF COLON expressao_classes propriedades','subclasso_classes',4,'p_subclasso_classes','app.py',192),
  ('subclasso_classes -> SUBCLASSOF COLON expressao_classes descricao_classes','subclasso_classes',4,'p_subclasso_classes','app.py',193),
  ('subclasso_classes -> SUBCLASSOF COLON expressao_classes','subclasso_classes',3,'p_subclasso_classes','app.py',194),
  ('subclasso_classes -> DISJOINTCLASSES COLON expressao_classes descricao_classes','subclasso_classes',4,'p_subclasso_classes','app.py',195),
  ('subclasso_classes -> DISJOINTCLASSES COLON expressao_classes','subclasso_classes',3,'p_subclasso_classes','app.py',196),
  ('subclasso_classes -> EQUIVALENTO COLON expressao_classes descricao_classes','subclasso_classes',4,'p_subclasso_classes','app.py',197),
  ('subclasso_classes -> EQUIVALENTO COLON expressao_classes','subclasso_classes',3,'p_subclasso_classes','app.py',198),
  ('subclasso_classes -> empty','subclasso_classes',1,'p_subclasso_classes','app.py',199),
  ('propriedades -> expressao_classes descricao_classes propriedades','propriedades',3,'p_properties','app.py',222),
  ('propriedades -> expressao_classes propriedades','propriedades',2,'p_properties','app.py',223),
  ('propriedades -> empty','propriedades',1,'p_properties','app.py',224),
  ('descricao_individuals -> INDIVIDUALS COLON ID COMMA ID descricao_individuals','descricao_individuals',6,'p_descricao_individuals','app.py',231),
  ('descricao_individuals -> INDIVIDUALS COLON ID','descricao_individuals',3,'p_descricao_individuals','app.py',232),
  ('descricao_individuals -> empty','descricao_individuals',1,'p_descricao_individuals','app.py',233),
  ('expressao_classes -> ID','expressao_classes',1,'p_expressao_classes','app.py',239),
  ('expressao_classes -> ID AND LPAREN expressao_classes COMMA expressao_classes RPAREN','expressao_classes',7,'p_expressao_classes','app.py',240),
  ('expressao_classes -> ID AND LPAREN expressao_classes COMMA ID SOME ID RPAREN','expressao_classes',9,'p_expressao_classes','app.py',241),
  ('expressao_classes -> ID AND LPAREN ID SOME ID RPAREN','expressao_classes',7,'p_expressao_classes','app.py',242),
  ('expressao_classes -> ID AND LPAREN ID COMMA ID SOME ID RPAREN','expressao_classes',9,'p_expressao_classes','app.py',243),
  ('empty -> <empty>','empty',0,'p_empty','app.py',260),
]
