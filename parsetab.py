...
_lr_productions = [
  ...
  ('ontologia -> descricao_classes descricao_individuals','ontologia',2,'p_ontologia','App.py',169),
  ('descricao_classes -> CLASS COLON ID subclasso_classes descricao_classes','descricao_classes',5,'p_descricao_classes','App.py',174),
  ('descricao_classes -> CLASS COLON ID','descricao_classes',3,'p_descricao_classes','App.py',175),
  ('subclasso_classes -> SUBCLASSOF COLON expressao_classes propriedades descricao_classes','subclasso_classes',5,'p_subclasso_classes','App.py',180),
  ('subclasso_classes -> SUBCLASSOF COLON expressao_classes propriedades','subclasso_classes',4,'p_subclasso_classes','App.py',181),
  ('subclasso_classes -> SUBCLASSOF COLON expressao_classes descricao_classes','subclasso_classes',4,'p_subclasso_classes','App.py',182),
  ('subclasso_classes -> SUBCLASSOF COLON expressao_classes','subclasso_classes',3,'p_subclasso_classes','App.py',183),
  ('subclasso_classes -> DISJOINTCLASSES COLON expressao_classes descricao_classes','subclasso_classes',4,'p_subclasso_classes','App.py',184),
  ('subclasso_classes -> DISJOINTCLASSES COLON expressao_classes','subclasso_classes',3,'p_subclasso_classes','App.py',185),
  ('subclasso_classes -> EQUIVALENTO COLON expressao_classes descricao_classes','subclasso_classes',4,'p_subclasso_classes','App.py',186),
  ('subclasso_classes -> EQUIVALENTO COLON expressao_classes','subclasso_classes',3,'p_subclasso_classes','App.py',187),
  ('subclasso_classes -> empty','subclasso_classes',1,'p_subclasso_classes','App.py',188),
  ('propriedades -> expressao_classes descricao_classes propriedades','propriedades',3,'p_properties','App.py',193),
  ('propriedades -> expressao_classes propriedades','propriedades',2,'p_properties','App.py',194),
  ('propriedades -> empty','propriedades',1,'p_properties','App.py',195),
  ...
  ('empty -> <empty>','empty',0,'p_empty','App.py',231),
]
